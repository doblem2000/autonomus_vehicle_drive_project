...
class Plot():
    ...
    def plot(self):
        ...
        plt.xlabel("Time")
        plt.ylabel("Speed")
        plt.legend(["Current Speed", "Target Speed"])
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Process speed file.')
    parser.add_argument('speed_file', type=str, help='Path to the speed file')

    args = parser.parse_args()
    figure_path = args.speed_file.split(".")[0]+".png"
    speed_plot = Plot(args.speed_file, figure_path)
    speed_plot.plot()